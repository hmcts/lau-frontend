...
Scenario('Navigate to LAU, perform case audit search and authenticate case activity results', async ({I}) => {
  ...
  await I.waitForText('Note: Results returned have been capped at 10,000.');
  await I.click('Next >');
  await I.wait(10);
  ...
  await I.waitForText('Displaying 101 to 200 of 10,000 records');
  await I.waitForText('Note: Results returned have been capped at 10,000.');
  await I.click('Last >>');
  await I.wait(10);
  ...
  await I.waitForText('Displaying 9,901 to 10,000 of 10,000 records');
  await I.waitForText('Note: Results returned have been capped at 10,000.');
