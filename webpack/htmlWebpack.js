...
const cssPath = path.resolve(__dirname, '../src/main/views/common/webpack/css-template.njk');
const jsPath= path.resolve(__dirname, '../src/main/views/common/webpack/js-template.njk');
